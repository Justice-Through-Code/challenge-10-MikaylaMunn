...
'''
my_song = {'artist': 'Lauryn Hill', 'title': 'Everything Is Everything'}
...
my_second_song = {"artist": "Carrie Underwoord", "title":"Blown Away"}
my_third_song = {"artist": "Laren Diagle", "title": "You Say"}
add_song(my_playlist, my_second_song)
add_song(my_playlist, my_third_song)
...
print(play_track(my_playlist, 2))
# See playlist_helpers.py for details on how to define this function
